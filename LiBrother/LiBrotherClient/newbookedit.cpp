...
void newbookedit::on_pushButton_3_clicked()
{
    ...
    if(iBook2->setDescription(nbDescription01.c_str())){}else{QMessageBox::information(this,"Warning",u8"简介录入失败");return;}
    if(library2->insertBook(iBook2)){}else{QMessageBox::information(this,"Warning",u8"无法写入");return;}
    QMessageBox::information(this,"Welcome",u8"新书添加成功");close();
