...
#include "../LiBrotherClient/useredit.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_useredit_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 56, 23) // "on_pushButton_2_clicked"
    ...
    "useredit\0on_pushButton_3_clicked\0\0"
...
void useredit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        useredit *_t = static_cast<useredit *>(_o);
        switch (_id) {
...
const QMetaObject useredit::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_useredit.data,
      qt_meta_data_useredit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *useredit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_useredit.stringdata))
        return static_cast<void*>(const_cast< useredit*>(this));
